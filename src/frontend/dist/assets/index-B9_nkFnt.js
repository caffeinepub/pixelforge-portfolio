...
const SCENE_DURATIONS = [4500, 3500, 4e3, 5e3, 3500, 3500, 4e3];
...
function PromoVideo({ onClose }) {
  const canvasRef = reactExports.useRef(null);
  const particlesRef = reactExports.useRef([]);
  const rafRef = reactExports.useRef(0);
  const sceneRef = reactExports.useRef(0);
  const startTimeRef = reactExports.useRef(Date.now());
  const burstRef = reactExports.useRef(false);
  ...
  const [line1Visible, setLine1Visible] = reactExports.useState(false);
  const [line2Visible, setLine2Visible] = reactExports.useState(false);
  reactExports.useEffect(() => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                ...
                height: "3px",
                width: `${progress * 100}%`,
                background: "linear-gradient(90deg, oklch(0.62 0.24 285), oklch(0.65 0.22 250))",
                zIndex: 10,
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    scene === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Scene1, {}),
                    scene === 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(Scene2, {}),
                    scene === 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(Scene3, {}),
                    scene === 3 && /* @__PURE__ */ jsxRuntimeExports.jsx(Scene4, { visibleCards }),
                    scene === 4 && /* @__PURE__ */ jsxRuntimeExports.jsx(Scene5, { line1: line1Visible, line2: line2Visible }),
                    scene === 5 && /* @__PURE__ */ jsxRuntimeExports.jsx(Scene6, {}),
                    scene === 6 && /* @__PURE__ */ jsxRuntimeExports.jsx(Scene7, { onClose })
                  ]
                }
              )
            }
          ),
          scene === 4 && /* @__PURE__ */ jsxRuntimeExports.jsx(CodeRain, {})
        ]
      }
    )
  ] });
...
function Scene1() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
    WIREFRAMES.map((wf) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          position: "absolute",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h1",
      {
        ...
        children: "Every great brand begins with a powerful digital presence."
      }
    )
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: GRID_ROWS.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              display: "flex",
            ...
            children: GRID_COLS.map((j) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  flex: 1,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
        ...
        children: "Most businesses are stuck with websites that don't perform."
      }
    )
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: FORGE_LETTERS.map(({ ch, id }, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            style: {
              fontSize: "clamp(2.5rem, 7vw, 7rem)",
              fontWeight: 900,
              background: "linear-gradient(135deg, oklch(0.82 0.22 285), oklch(0.72 0.22 250))",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: ch === "_" ? "transparent" : void 0,
              backgroundClip: "text",
              display: "inline-block",
              animation: `sparkDrop 0.5s ease ${0.3 + idx * 0.08}s both`,
              fontFamily: "sans-serif",
              letterSpacing: ch === "_" ? "0.3em" : "0.02em",
              color: ch === "_" ? "transparent" : void 0
            },
            children: ch === "_" ? " " : ch
          },
          id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        ...
        children: "Where pixels become powerful."
      }
    )
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: FEATURE_CARDS.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    fontSize: "28px",
                    marginBottom: "12px",
                    background: "linear-gradient(135deg, oklch(0.75 0.22 285), oklch(0.72 0.22 250))",
                    WebkitBackgroundClip: "text",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          ...
          width: "500px",
          height: "300px",
          background: "radial-gradient(ellipse, oklch(0.62 0.24 285 / 0.25) 0%, transparent 70%)",
          pointerEvents: "none",
          borderRadius: "50%"
        }
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
        style: {
          ...
          fontWeight: 900,
          background: "linear-gradient(135deg, oklch(0.82 0.22 285), oklch(0.72 0.22 250), oklch(0.78 0.20 230))",
          WebkitBackgroundClip: "text",
          WebkitTextFillColor: "transparent",
          backgroundClip: "text",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          ...
          width: "200px",
          margin: "0 auto 20px",
          background: "linear-gradient(90deg, transparent, oklch(0.62 0.24 285 / 0.8), transparent)",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        ...
        children: "Where Ideas Become Digital Experiences"
      }
    )
  ] });
}
function Scene7({ onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
        ...
        children: "Build your digital future."
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        ...
        children: "Powered by Pixel Forge"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        style: {
          ...
          fontWeight: 700,
          color: "#fff",
          background: "linear-gradient(135deg, oklch(0.62 0.24 285), oklch(0.65 0.22 250))",
          border: "none",
          borderRadius: "100px",
          cursor: "pointer",
          animation: "fadeUp 0.8s ease 1.1s both, borderGlow 2s ease-in-out 1.5s infinite",
          fontFamily: "sans-serif",
          letterSpacing: "0.02em",
...
function CodeRain() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: CODE_COLUMNS.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
            position: "absolute",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "PixelForge" })
            }
          ),
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden nav-glass border-t border-white/5 px-6 py-4 flex flex-col gap-1", children: [
          NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 14, className: "text-primary/60" }),
                link.label
              ]
            },
            link.href
...
function HeroSection({ onWatchPromo }) {
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 -z-10 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.62 0.24 285) 0%, transparent 70%)",
                filter: "blur(80px)"
              }
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.55 0.22 270) 0%, transparent 70%)",
                filter: "blur(100px)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundImage: "linear-gradient(oklch(0.62 0.24 285 / 0.4) 1px, transparent 1px), linear-gradient(90deg, oklch(0.62 0.24 285 / 0.4) 1px, transparent 1px)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-5xl mx-auto px-6 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 mb-8 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-sm font-medium text-primary/90 animate-in-hidden animate-in-visible", children: [
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "block",
                    style: {
                      background: "linear-gradient(110deg, oklch(0.88 0.18 285) 0%, oklch(0.80 0.26 275) 35%, oklch(0.72 0.26 255) 65%, oklch(0.78 0.20 240) 100%)",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                      backgroundClip: "text"
                    },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "block",
                    style: {
                      background: "linear-gradient(110deg, oklch(0.75 0.22 265) 0%, oklch(0.82 0.20 250) 50%, oklch(0.90 0.12 240) 100%)",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                      backgroundClip: "text"
                    },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-2xl mx-auto text-lg md:text-xl text-muted-foreground leading-relaxed mb-10", children: "Creating clean, high-converting websites that help businesses grow online." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-20 flex flex-wrap items-center justify-center gap-8 text-sm text-muted-foreground/60 font-mono", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-muted-foreground/40 text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-px h-12",
              style: {
                background: "linear-gradient(to bottom, transparent, oklch(0.62 0.24 285 / 0.5))"
              }
            }
          ),
          "scroll"
...
function AboutSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "about", className: "section-pad relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-16 lg:gap-24 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-mono font-medium text-primary/70 tracking-widest uppercase mb-4 block", children: "Who We Are" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl md:text-5xl leading-tight mb-8", children: [
                "About ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "PixelForge" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg", children: "At PixelForge, we specialize in crafting modern, fast, and visually stunning websites that help businesses build a powerful online presence." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Every project is built with precision, creativity, and a deep understanding of what drives results — combining beautiful design with performance to create digital experiences your audience will remember." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "From sleek landing pages to full-featured business websites, our work is rooted in strategy, refined through design, and brought to life with clean, performant code." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: stats.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground font-medium", children: stat.label })
                ]
              },
              stat.label
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 glass-card rounded-2xl p-6 flex items-center gap-4 service-card", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0",
                  style: { background: "var(--pf-gradient)" },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 22, className: "text-white" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Available for New Projects" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Fast turnaround · Pixel-perfect execution" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
...
const SERVICES = [
  {
    ...
    description: "Bespoke designs built from scratch — every pixel crafted to reflect your brand identity and capture your audience's attention.",
    accent: "oklch(0.62 0.24 285)"
  },
  {
    icon: FileText,
    title: "Landing Page Design",
    description: "High-converting landing pages with clear hierarchy, persuasive copy placement, and strategic CTAs that turn visitors into customers.",
    accent: "oklch(0.65 0.22 250)"
  },
  {
    icon: CodeXml,
    title: "Business Website Development",
    description: "Full-featured business websites with performance-first architecture, clean code, and seamless CMS integration.",
    accent: "oklch(0.58 0.22 270)"
  },
  {
    icon: RefreshCw,
    title: "Website Redesign",
    description: "Transform your outdated website into a modern digital experience that reflects where your business is today.",
    accent: "oklch(0.68 0.20 260)"
  }
];
function ServicesSection() {
  const { ref: titleRef, visible: titleVisible } = useInView();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "services", className: "section-pad relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-mono font-medium text-primary/70 tracking-widest uppercase mb-4 block", children: "What We Offer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl md:text-5xl mb-5", children: [
              "What We ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Do" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto", children: "From concept to launch, we handle every aspect of your web presence with craft and intent." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-5", children: SERVICES.map((service, i) => {
        const Icon2 = service.icon;
        return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay: i * 80, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20, style: { color: service.accent } })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function PortfolioCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay: index2 * 100, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/10] overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `absolute inset-0 bg-gradient-to-t ${project.gradient} transition-opacity duration-300 ${hovered ? "opacity-100" : "opacity-0"}`
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `absolute inset-0 flex items-center justify-center transition-all duration-300 ${hovered ? "opacity-100 scale-100" : "opacity-0 scale-95"}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "btn-glow-primary px-5 py-2.5 rounded-xl text-white font-semibold text-sm flex items-center gap-2", children: [
                "View Project ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-base text-foreground", children: project.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: project.type })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ArrowUpRight,
              {
                size: 16,
                className: `text-primary/60 transition-transform duration-200 flex-shrink-0 mt-0.5 ${hovered ? "translate-x-0.5 -translate-y-0.5 text-primary" : ""}`
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: project.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
function PortfolioSection() {
  const { ref: titleRef, visible: titleVisible } = useInView();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "portfolio", className: "section-pad relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          className: `animate-in-hidden ${titleVisible ? "animate-in-visible" : ""} text-center mb-16`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-mono font-medium text-primary/70 tracking-widest uppercase mb-4 block", children: "Case Studies" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl md:text-5xl mb-5", children: [
              "Our ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Work" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto", children: "A selection of recent projects — each built with craft, purpose, and measurable impact." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-5", children: PROJECTS.map((project, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PortfolioCard, { project, index: i }, project.title)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatedSection, { className: "text-center mt-14", delay: 200, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-5", children: "Like what you see? Let's build something great together." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
...
function ContactSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", className: "section-pad relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-[600px] h-[400px] opacity-15",
        style: {
          background: "radial-gradient(ellipse, oklch(0.62 0.24 285) 0%, transparent 70%)",
          filter: "blur(100px)"
        }
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-mono font-medium text-primary/70 tracking-widest uppercase mb-4 block", children: "Let's Talk" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl md:text-5xl mb-5", children: [
              "Get In ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Touch" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xl max-w-xl mx-auto", children: "Have a project in mind? Let's build something great together." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            ...
            boxShadow: "0 0 60px oklch(0.62 0.24 285 / 0.07), 0 24px 80px oklch(0 0 0 / 0.3)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-8", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono uppercase tracking-widest mb-0.5", children: "Email Us" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    children: "pixelforge1515@gmail.com"
                  }
                )
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gradient-divider mb-8 max-w-xs mx-auto" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground/50", children: ["No contracts", "Free consultation", "Fast delivery"].map(
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border/40 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl gradient-text", children: "PixelForge" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground/40 text-sm", children: [
        "© ",
        year,
        " All rights reserved."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-6 text-sm text-muted-foreground/60", children: ["About", "Services", "Portfolio", "Contact"].map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        ...
        onClick: (e) => {
          var _a2;
          e.preventDefault();
          (_a2 = document.querySelector(`#${link.toLowerCase()}`)) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground/40", children: [
      "Built with ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-400/70", children: "♥" }),
      " using",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    showPromo && /* @__PURE__ */ jsxRuntimeExports.jsx(PromoVideo, { onClose: () => setShowPromo(false) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSection, { onWatchPromo: () => setShowPromo(true) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gradient-divider" }) }),
...
Service({
  ...
  "submitContactForm": Func([Text, Text, Text], [], [])
});
